@echo off
echo ===================================================
echo Demarrage du systeme de recommandation - Version avec nombre exact
echo ===================================================
...
echo - Amelioration de la generation des lieux uniques
echo - Verification du nombre final de recommandations
echo - Tri des recommandations par score
echo.
echo Pour tester:
...
echo 7. Essayez avec differents nombres de recommandations
echo.
